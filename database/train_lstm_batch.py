...
def load_dataset(cursor, commodity: str) -> dict[str, object]:
    ...
    # PENCEGAHAN DATA LEAKAGE: xmin/xmax untuk (de)normalisasi harus sama dengan parameter yang
    # dipakai DataPreprocessingLstm::prepareCommodityRows() saat menormalisasi, yaitu hanya dari
    # porsi data latih (set_data == "Latih"), bukan dari seluruh baris komoditas (latih + uji).
    # Menghitungnya dari seluruh baris membuat skala normalisasi "mengetahui" rentang nilai pada
    # periode uji sebelum model sempat dilatih.
    train_clean_values = [
